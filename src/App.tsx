...
function App() {
  ...
  useEffect(() => {
    ...
    const formatTrackData = (allData: [PlaylistTrack[], PlaycountAPIResponse[]]) => {
      ...
      setFormattedTracks(dummyFormattedTrackData);
    ...
    <div className='container'>
      ...
      <footer className="footer">
        <div className="footer-links">
          <span>© 2024 built by @jaerodyne</span>
          <a href="https://visitorbadge.io/status?path=https%3A%2F%2Fdrizzyvskdot.netlify.app"><img src="https://api.visitorbadge.io/api/visitors?path=https%3A%2F%2Fdrizzyvskdot.netlify.app&countColor=%23263759" /></a>
          <button type="button">
